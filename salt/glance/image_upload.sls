...
image_download:
  cmd:
  - run
  - name: wget -p /root/  http://download.cirros-cloud.net/0.3.3/cirros-0.3.3-x86_64-disk.img
...
glance_upload:
  cmd:
  - run
  - name: glance image-create --name "cirros-0.3.3-x86_64-disk.img" --file /root/download.cirros-cloud.net/0.3.3/cirros-0.3.3-x86_64-disk.img --disk-format qcow2 --container-format bare --is-public True --progress
